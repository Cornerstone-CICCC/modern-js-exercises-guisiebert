...
- an array of strings, where each string represents a small air sample that is either clean or dirty. 
- a number representing the highest acceptable amount of dirty samples. 
...
const checkAir = function (samples, threshold) {
  ...
  const isAcceptable = count / samples.length < threshold

  return isAcceptable ? "Clean" : "Polluted" 
};
